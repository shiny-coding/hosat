...
// var cells = Board.createCells();
// var units = Board.createUnits();
...
// var cells = SomeClass.createCells();
// cells[0][0].

class UnitClass{
    static createCells(){
        let cells = [];
        cells.push( [ new Cell( 23, { x: 1, y: 2 } ) ] );
        return cells;
    }
}
// var cells = SomeClass2.createCells();
// cells[0][0].
...
// var cell1 = new Cell( 1, { x:3, y:2 } );
// var cell2 = new Cell( 2, { x:4, y:5 } );
